...
const insights = [
  ...
  {
    title: '洞察 4 「舊客撐盤」—— 品牌過度依賴單一客群，結構風險升高',
    sections: [
      { label: "▶ 數據發現", items: [
        { text: "威德既有買者人數 YoY +23%，銷額 +19%，是品牌唯一成長的客群，貢獻 57% 銷額。舊客行為穩健：人均次 +3%、單次金 +5%。", src: "P38" },
        { text: "但品牌整體人均次 -6%（1.5 次），是被新客（人均次 -3%、單次金 -6%）和競品客（人均次 -6%、單次金 -5%）的大幅衰退拖累。", src: "P4, P38" },
        { text: "威德中/重度買者人數增加，但輕度買者銷額 YoY -5%，正在流失。", src: "P60" },
        { text: "威德買者離開品類的人數是流失至競品的 5 倍，顯示更大的問題不是被搶走，而是消費者直接不買了。", src: "P49" },
      ]},
      { label: "▶ 市場洞察", items: [
        { text: "威德舊客的行為其實穩健——人均次 +3%、單次金 +5%，留下來的人買得更勤、花得更多。品牌整體人均次 -6% 是被新客（-3%）和競品客（-6%）的萎縮拖累。真正的風險不是舊客變差，而是品牌過度依賴舊客：新客/競品客持續萎縮，一旦舊客人數增長放緩或自然流失，品牌將沒有後備力量。", src: "P38 + 推論" },
        { text: "更值得警惕的是：買者離開品類（直接不買益生菌）的比例遠高於流失至競品，意味著威德需要在「品類需求維持」上加強經營，而不僅僅是防守競品搶客。", src: "P49 + 推論" },
      ]},
      { label: "▶ 突破方向", items: [
...
async function main() {
  const children = [
    ...
    BULLETSRC("重度買者：人均年購 4.5 次，年消費 > NT$7,504，人數 +13% 但人均次 -4%、單次金 -5% — 這是市場整體數據，主因是中度買者升級進來拉低平均值，非代表個別重度買者行為變差", "P17, P18"),
